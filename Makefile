...
SOURCES = \
	__init__.py \
	get_nsi_data.py get_nsi_data_dialog.py

PLUGINNAME = get_nsi_data

PY_FILES = \
	__init__.py \
	get_nsi_data.py get_nsi_data_dialog.py

UI_FILES = get_nsi_data_dialog_base.ui

EXTRAS = metadata.txt icon.png tracts_nested.json
...
QGISDIR=C:\Users\sbs44\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
